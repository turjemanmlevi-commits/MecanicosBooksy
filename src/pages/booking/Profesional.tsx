    ...
    return (
        <div className="flex flex-col h-full animate-fade-in">
            ...
            <div className="flex-1 space-y-4 overflow-y-auto pb-4">
                {loading ? (
                    <div className="text-center text-gray-400 py-10">Cargando técnicos...</div>
                ) : (
                    <>
                        {/* Option: Anyone */}
                        <div
                        ...
                        >
                            ...
                            <div className="absolute bottom-4 left-4">
                                <div className="flex items-center gap-2 mb-1">
                                    ...
                                    <h3 className="text-xl font-bold">Cualquiera</h3>
                                </div>
                                <p className="text-sm text-gray-300">Primer técnico disponible</p>
                            </div>
                        </div>
